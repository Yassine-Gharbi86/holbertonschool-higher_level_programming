#!/usr/bin/python3
"""Module that defines a Rectangle with width and height validation, area, \
    perimeter computation, string representation, deletion message, \
...
class Rectangle:
    """Represents a rectangle with width and height validation,\
          area, perimeter computation, string representation, \
            deletion message, and customizable print symbol."""
